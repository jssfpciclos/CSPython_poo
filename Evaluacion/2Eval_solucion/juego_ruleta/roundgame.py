                    ...
                    match tipoMovimiento:
                        case JugadorTipoMovientoEnum.RESOLVER:
                            ...
                            if resultado:
                                ...
                                jugador.addPrizeRound(Constantes.RECOMPENSA_PANEL)
                        ...
                        case JugadorTipoMovientoEnum.LETRA:
                            ...
                            if letra in Constantes.VOCALES:
                                jugador.addPrizeRound(Constantes.VOCAL_PRECIO * -1)
                                print(f"  Has comprado vocal. Pagas {Constantes.VOCAL_PRECIO:.2f}. Te queda "
